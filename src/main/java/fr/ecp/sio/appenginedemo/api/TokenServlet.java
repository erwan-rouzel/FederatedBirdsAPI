...
public class TokenServlet extends JsonServlet {
    ...
    /**
     * @api {post} /auth/token Generate authentication token
     * @apiName PostAuthentication
     * @apiGroup Authentication
     *
     * @apiParam (Header parameter) {String} login The login of the user.
     * @apiParam (Header parameter) {String} password The password of the user.
     *
     * @apiSuccess {String} token The generated token for user.
     *
     ...
     * @apiError invalidLogin Incorrect password
     * @apiError invalidPassword User not found
     *
